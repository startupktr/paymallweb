import { ShoppingCart, Clock, Users, Store, Smartphone, Shield, ChevronRight, Check, Menu, X, Mail, Phone, MapPin, Play, Facebook, Twitter, Instagram, Linkedin, Youtube } from "lucide-react";
import { Button } from "@/components/ui/button";
import phoneMockup from "@/assets/phone-mockup.png";
import heroBg from "@/assets/hero-bg.jpg";
import paymallLogo from "@/assets/paymall-logo.png";
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 gradient-glass border-b border-border/50">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <a href="#" className="flex items-center gap-2">
          <img src={paymallLogo} alt="PayMall Logo" className="w-12 h-12 object-contain" />
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="#videos" className="text-muted-foreground hover:text-foreground transition-colors font-medium">Videos</a>
      ...
      {isOpen && (
        <div className="md:hidden bg-card border-t border-border py-4 px-4 space-y-4">
          ...
          <a href="#videos" className="block py-2 text-muted-foreground hover:text-foreground">Videos</a>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <div className="flex items-center gap-4 mb-6">
              <img src={paymallLogo} alt="PayMall Logo" className="w-20 h-20 object-contain drop-shadow-2xl" />
...
const VideoSection = () => {
  const videos = [
    {
      id: "dQw4w9WgXcQ",
      title: "How PayMall Works",
      description: "Watch our quick demo to see PayMall in action"
    },
    {
      id: "dQw4w9WgXcQ",
      title: "Customer Success Story",
      description: "Hear from real customers about their experience"
    },
    {
      id: "dQw4w9WgXcQ",
      title: "Business Integration Guide",
      description: "Learn how easy it is to integrate PayMall"
    }
  ];
    ...
    <section id="videos" className="py-24 bg-background">
      <div className="container px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold mt-4 mb-6 text-foreground">
            See PayMall in Action
          </h2>
          <p className="text-lg text-muted-foreground">
            Watch our videos to learn how PayMall is transforming the shopping experience
          </p>
        </div>
        
        <div className="grid md:grid-cols-3 gap-8">
          {videos.map((video, index) => (
            <div key={index} className="bg-card rounded-3xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-border/50">
              ...
              <div className="p-6">
                <h3 className="font-display font-bold text-lg mb-2 text-foreground">{video.title}</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-display font-semibold text-lg mb-1 text-foreground">Email Us</h3>
                <p className="text-muted-foreground">hello@paymall.app</p>
                <p className="text-muted-foreground">support@paymall.app</p>
              </div>
            </div>
            
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-2xl gradient-coral flex items-center justify-center flex-shrink-0">
                <Phone className="w-6 h-6 text-secondary-foreground" />
              </div>
              <div>
                <h3 className="font-display font-semibold text-lg mb-1 text-foreground">Call Us</h3>
                <p className="text-muted-foreground">1-800-PAY-MALL</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-display font-semibold text-lg mb-1 text-foreground">Visit Us</h3>
            ...
            <div className="pt-6">
              <h3 className="font-display font-semibold text-lg mb-4 text-foreground">Follow Us</h3>
              <div className="flex gap-4">
                <a href="#" className="w-12 h-12 rounded-full bg-card border border-border/50 flex items-center justify-center hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all duration-300">
      ...
      <div className="container px-4">
        ...
        <div className="border-t border-primary-foreground/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            <img src={paymallLogo} alt="PayMall" className="w-8 h-8 object-contain" />
